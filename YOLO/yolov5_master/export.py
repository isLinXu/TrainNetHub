...
from YOLO.yolov5_master.utils.activations import SiLU
from YOLO.yolov5_master.utils.datasets import LoadImages
from YOLO.yolov5_master.utils.general import colorstr, check_dataset, check_img_size, check_requirements, file_size, print_args, \
...
def export_saved_model(model, im, file, dynamic,
    ...
    try:
        ...
        from YOLO.yolov5_master.models.tf import TFModel, TFDetect
...
def export_tflite(keras_model, im, file, int8, data, ncalib, prefix=colorstr('TensorFlow Lite:')):
    ...
    try:
        import tensorflow as tf
        from YOLO.yolov5_master.models.tf import representative_dataset_gen
