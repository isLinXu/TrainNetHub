...
from YOLO.yolov5_master.utils.datasets import img2label_paths
from YOLO.yolov5_master.utils.general import check_dataset, check_file
       ...
       """
        ...
        if isinstance(opt.resume, str):  # checks resume from artifact
            ...
            self.wandb_run = wandb.init(config=opt,
                                        resume="allow",
                                        project='trainnethub' if opt.project == 'runs/train' else Path(opt.project).stem,
                                        entity=opt.entity,
