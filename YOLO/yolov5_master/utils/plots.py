...
from YOLO.yolov5_master.utils.general import xywh2xyxy, xyxy2xywh
...
def hist2d(x, y, n=100):
    """
    labels.png和evolve.png中使用的二维直方图
...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=640, max_subplots=16):
    ...
    :param labels：一个batch的标签
    :param paths：一个batch的文件名
    :param fname：保存可视化之后大图的文件路径
    :param names：类别名
    :param max_size：限制每张可视化图片的最大图片大小
    :param max_subplots：最多可视化batch-size=16张图片
    """
...
def plot_study_txt(path='', x=None):  # from utils.plots import *; plot_study_txt()
    """通过val.py画yolov5学习曲线，也就是README.md中的曲线图"""
...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path('runs/detect/exp')):
    ...
    module_type:    Module type,模型类别
    stage:          Module stage within model
    n:              Maximum number of feature maps to plot
    save_dir:       Directory to save results, 最多可视化多少个channel
    """
