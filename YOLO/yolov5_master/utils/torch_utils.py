...
def scale_img(img, ratio=1.0, same_shape=False, gs=32):  # img(16,3,256,416)
    """缩放tensor
    :param img：需要缩放的tensor，shape为[batch-size, channle, h, w]
    :param ratio: 缩放率
    :param same_shape:缩放后，是否pad回原img大小
    :param gs:缩放后size需要整除gs
    """
...
def copy_attr(a, b, include=(), exclude=()):
    """将b的属性复制给a,
    :param include:复制include中的
    :param exclude:排除exclude中的
    """
